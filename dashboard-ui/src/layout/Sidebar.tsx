...
import { LayoutDashboard, Bell, Users, Radio, Settings, Globe, MessageSquare, Phone, Rss, ChevronRight, ChevronLeft } from 'lucide-react';
...
const GROUPS = [
  ...
  { label: 'ניהול', items: [{ to: '/settings', icon: Settings, label: 'הגדרות' }, { to: '/landing', icon: Globe, label: 'אתר נחיתה' }, { to: '/messages', icon: MessageSquare, label: 'תבניות' }, { to: '/whatsapp', icon: Phone, label: 'WhatsApp' }, { to: '/whatsapp-listeners', icon: Rss, label: 'WA Listeners' }] },
];
