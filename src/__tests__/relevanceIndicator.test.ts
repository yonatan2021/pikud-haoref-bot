...
describe('buildAlertDmMessage — relevance indicator', () => {
  ...
  it('omits indicator when homeCity is null', () => {
    ...
    // The relevance indicator is a standalone line like '🔴 באזורך' or '🟡 באזור קרוב' or '🟢 לא באזורך'
    // Without indicator, the first line is the title (e.g. '🔴 התרעת טילים באזורך')
