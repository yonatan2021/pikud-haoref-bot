...
[![גרסה](https://img.shields.io/badge/גרסה-0.2.2-brightgreen?style=for-the-badge)](CHANGELOG.md)
...
| 🗺️ **מפה לכל התראה** | הדגשת האזורים המוזהרים על המפה בצבע לפי סוג האירוע |
| 📢 **5 קטגוריות נושא** | ביטחוני, טבע, סביבתי, תרגילים, כללי — ניתוב לערוץ המתאים |
| 🔔 **DM אישי** | הודעה ישירה רק כשמוזהרת עיר שבחרת — פורמט קצר או מפורט |
