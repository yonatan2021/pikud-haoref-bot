...
[![גרסה](https://img.shields.io/badge/גרסה-0.3.1-brightgreen?style=for-the-badge)](CHANGELOG.md)
...
| 🗺️ **מפה לכל התראה** | הדגשת האזורים המוזהרים בצבע לפי סוג האירוע; סגנון מפה בהיר ביום (06:00–18:00) וכהה בלילה (18:00–06:00); fallback לסמני מיקום כשאין נתוני polygon |
