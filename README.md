...
[![גרסה](https://img.shields.io/badge/גרסה-0.4.2-brightgreen?style=for-the-badge)](CHANGELOG.md)
...
| 📢 **6 קטגוריות נושא**  | ביטחוני, טבע, סביבתי, תרגילים, WhatsApp, כללי — ניתוב לערוץ המתאים                                                                                                                                                                                                                                                                                          |
...
| ⏱️ **זמן מקלט ב-DM**    | כל הודעת DM מציגה את זמן ההגעה למרחב מוגן (`⏱ X שנ׳`) עבור הערים שלך                                                                                                                                                                                                                                                                                        |
...
| 👋 **Onboarding חכם**   | משתמש חדש נכנס ל-wizard אינטראקטיבי ב-`/start` — שם, עיר מגורים, והרשמה אוטומטית; מצב נשמר ב-DB ושורד ריסטארט                                                                                                                                                                                                                                               |
| ✏️ **פרופיל אישי**       | `/profile` — צפייה ועריכה של שם תצוגה ועיר מגורים; קוד חיבור מוצג בפרופיל; בחירת שפה מוכנה ל-i18n עתידי                                                                                                                                                                                                                                                                              |
| 🔗 **אנשי קשר**          | `/connect` — קוד חיבור ייחודי 6 ספרות; בקשת קשר הדדית עם אישור/דחייה; `/contacts` — רשימה עם pagination, הסרה, וכפתור הרשאות (v0.4.3)                                                                                                                                                                                                                                                 |
| 🛡️ **אנטי-ספאם קשרים**   | מגבלת 10 בקשות ממתינות, חסימה אחרי 5 ניסיונות שגויים, cooldown 5 שניות, פקיעה אוטומטית אחרי 7 ימים + ניקוי מחזורי כל 6 שעות                                                                                                                                                                                                                                                                              |
