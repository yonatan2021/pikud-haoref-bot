...
[![גרסה](https://img.shields.io/badge/גרסה-0.4.4-brightgreen?style=for-the-badge)](CHANGELOG.md)
...
| 🏁 **אישור סיום התרעה**   | הודעת "הסתיימה ההתרעה" לאחר כל אזעקה, עם חלון שקט למניעת הצפה                                                                            |
...
| 🏁 **allClearTracker**      | מעקב all-clear per-zone עם injectable deps, חלון שקט (quiet window) ומחיקת timers בעת SIGTERM/SIGINT                                       |
